...
void main() {
    // Use full image dimensions for position-dependent spiral math
    ...
    // Convert distorted global UV back to tile-local UV for texture sampling.
    // When not tiling, tileOffset=0 and fullResolution=resolution, so this is a no-op.
