...
render(o1)`
        ...
        if (starter) {
            ...
            const generatorCall = fmtCall('noise3d', { volumeSize: `x${consumerVolumeSize}` })
            const effectCall = fmtCall(funcName, kwargs)
            // render3d, renderLit3d, and renderCube ARE renderers - don't append another .render3d() call
            const renderSuffix = (funcName === 'render3d' || funcName === 'renderLit3d' || funcName === 'renderCube') ? '' : '\n  .render3d()'
