...
.. code-block:: bash
   ...
   node test-harness.js --effects "synth/ca,points/physarum" --webgpu --all --with-ai

   # Structure check (no browser)
   node test-harness.js --effects "points/physarum" --webgl2 --structure
